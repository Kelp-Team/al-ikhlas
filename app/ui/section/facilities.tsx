...
export function Facilities() {
  return (
    <section className="bg-brown py-16 px-12" id="facilities">
      <div className="flex items-center gap-2.5 text-gold-light text-[0.65rem] tracking-[0.22em] uppercase mb-2.5">
        <span className="w-5 h-px bg-gold" />
        What We Offer
      </div>
      <h2 className="text-cream text-3xl font-light mb-10">Facilities & Amenities</h2>

      <div className="grid grid-cols-4 gap-0.5 bg-[var(--charcoal)]">
