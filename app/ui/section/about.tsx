  ...
  return (
    <section className="grid md:grid-cols-2" id="about">
      <div className="bg-background p-6 md:p-14">
        ...
        <blockquote className="font-serif text-foreground text-xl md:text-2xl font-light italic leading-relaxed border-l-2 border-secondary pl-4 md:pl-7 my-7 md:my-9">
          &ldquo;The mosque is the heart of the Muslim community &mdash; a place
          of worship, learning, and belonging.&rdquo;
        </blockquote>
        <p className="text-muted-foreground text-justify leading-relaxed ">
          Masjid Al-Ikhlas has served the Shah Alam community since 2013. Our
          mission is to provide a welcoming space for worship, education, and
          community programmes that bring Muslims together and serve our
          neighbours of all backgrounds. We run weekly classes, monthly events,
          and daily programmes to keep our jemaah spiritually nourished and
          connected.
        </p>
      </div>

      <div className="bg-muted p-6 md:p-14 flex flex-col justify-center gap-6 md:gap-8">
        <Gallery />
      </div>
    </section>
  );
