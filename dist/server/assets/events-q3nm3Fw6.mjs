import { r as requireAdmin, d as db, e as event, a as revalidatePath, b as registerServerReference } from "../index.mjs";
...
async function createEvent(prevState, formData) {
  ...
  const displayNumber = formData.get("displayNumber") || null;
  const dateNum = formData.get("dateNum") || null;
  if (!title || !category) {
